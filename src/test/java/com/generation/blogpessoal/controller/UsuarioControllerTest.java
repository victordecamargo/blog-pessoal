...
public class UsuarioControllerTest {
	...
	void start() {
		...
		usurioService.cadastrarUsuario(new Usuario(0L,
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario(0L,
				"Paulo Antunes", "paulo_autunes@email.com.br", "13465278", "-"));
	...
	public void deveAtualizarUmUsuario() {
		Optional<Usuario> usuarioCadastrado = usurioService.cadastrarUsuario(new Usuario(0l,
				"Juliana Andrews", "juliana_andrewa@email.com.br", "juliana123", "-"));
